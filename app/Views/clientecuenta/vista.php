  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">¿Esta seguro de Dar de baja su cuenta?   </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        una vez dada de baja su cuenta tendra que contactar con el administrador para volverla activar.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="bajaCuenta(<?php echo $id?>)">confirmar</button>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
								<button type="button" id="btnModificar"data-toggle="modal" data-target="#exampleModal" name="btnModificar" onclick="ActualizarDatos(<?php echo $id?>)" class="btn btn-primary">Modificar</button>
							</div>
						</div>
					</div>
				</div>
